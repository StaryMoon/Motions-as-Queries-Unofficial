...
<p align="center">
  <img src="assets/paper-preview.png" alt="Motions-as-Queries-Unofficial paper or project page preview" width="900">
</p>
...
| Item | Details |
|---|---|
| Paper | Motions as Queries: One-Stage Multi-Person Holistic Human Motion Capture |
| Venue / Source | CVPR 2025 |
| Focus | This repository organizes a PyTorch implementation for Motions as Queries: One-Stage Multi-Person Holistic Human Motion Capture, focusing on one-stage multi-person holistic moti... |
...
├── scripts/
│   └── smoke_test.py
├── src/motions_as_queries_unofficial/
│   ├── __init__.py
│   └── model.py
├── CITATION.cff
├── README.md
...
```python
import torch
from motions_as_queries_unofficial import ModelConfig, UnofficialModel, reconstruction_loss

config = ModelConfig(task="motion", hidden_dim=128, num_layers=2, num_heads=4)
...
```python
import torch
from motions_as_queries_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables, pp. 17529-17539 | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_Motions_as_Queries_One-Stage_Multi-Person_Holistic_Human_Motion_Capture_CVPR_2025_paper.html) |
| Ablation study | Ablation / experiment section | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_Motions_as_Queries_One-Stage_Multi-Person_Holistic_Human_Motion_Capture_CVPR_2025_paper.html) |
| Qualitative examples | Main paper figures and supplemental material | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_Motions_as_Queries_One-Stage_Multi-Person_Holistic_Human_Motion_Capture_CVPR_2025_paper.html) |
...
- Thanks to the authors of **Motions as Queries: One-Stage Multi-Person Holistic Human Motion Capture** for the original research.
...
cvpr-2025, pytorch, unofficial-implementation, human-motion-capture, pose-estimation, motion-reconstruction
